...
;(() => {
  ...
  var getAttribute = (element, name) => {
    ...
    return element && element.getAttribute
      ? (_a = element.getAttribute(name)) != null
        ? _a
        : void 0
      : void 0
  }
  ...
  var polyfillRequestIdleCallback = () => {
    if (
    ...
    globalThis.requestIdleCallback = (callback, _options) => {
      handleCounter++
      taskQueue.push({
        id: handleCounter,
        callback,
  ...
  var request_idle_callback_polyfill_default = polyfillRequestIdleCallback
  ...
  function isExcludedTag(tag) {
    if (!tag) return true
    const excludeRegex = /分割线|\d+年\d+月\d+日|\d+点\d+分\d+秒/
    return excludeRegex.test(tag)
  }
  ...
  async function generateMostUsedAndRecentAddedTags(recentTags) {
    ...
    for (const recentTag of recentTags) {
      if (!recentTag.tag || isExcludedTag(recentTag.tag)) {
        continue
      }
    ...
    const recentAddedTags2 = Array.from(
      new Set(
        recentTags
          .map((tag) => tag.tag)
          .reverse()
          .filter((tag) => tag && !isExcludedTag(tag))
      )
    ).slice(0, 200)
    await Promise.all([
  ...
  async function getMostUsedTags() {
    ...
    return Array.isArray(values)
      ? values.filter((tag) => !isExcludedTag(tag))
      : []
  }
  ...
  var messages17 = {
    ...
    "menu.hideAllTags": "Masquer toutes les \xE9tiquettes",
    "menu.unhideAllTags": "Afficher toutes les \xE9tiquettes",
  ...
  function extractTextWithImageAlt(element) {
    ...
    for (const node of Array.from(element.childNodes)) {
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        text += // If it's an image, append its alt attribute value
  ...
  function getDirectChildText(element) {
    ...
    for (const node of element.childNodes) {
      if (node.nodeType === Node.TEXT_NODE) {
        const text = ((_a = node.textContent) != null ? _a : "").trim()
  ...
  function updateCandidateTagList(ul, candidateTags, limitSize, isEmoji) {
    ...
    for (const text of candidateTags) {
      if (displayedTags.has(text) || isExcludedTag(text)) {
        continue
      }
  ...
  function interceptShadowDOM() {
    ...
    Element.prototype.attachShadow = function (init) {
      if (init && init.mode === "closed") {
        if (isCloudflareChallenges() || isContainCloudflareChallengesScript()) {
  ...
  var v2ex_default =
    ':not(#a):not(#b):not(#c) .header h1+.utags_ul_0{object-position:0% 200%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: -8px;--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5)}:not(#a):not(#b):not(#c) h1[data-utags_type=user][data-utags_fit_content="1"]{max-width:fit-content !important}:not(#a):not(#b):not(#c) h1[data-utags_type=user]+.utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: 0px;--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5)}:not(#a):not(#b):not(#c) [class*=v2p-theme] .utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) [class*=v2p-theme] .topic_info .utags_ul_1{z-index:2}:not(#a):not(#b):not(#c) .title .node-breadcrumb[data-utags_fit_content="1"]{display:inline-block !important;max-width:fit-content !important}:not(#a):not(#b):not(#c) .title .node-breadcrumb+.utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: 2px;--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) .title .node-breadcrumb+.utags_ul_1{object-position:200% 50%;position:absolute;top:-9999px}:not(#a):not(#b):not(#c) .box .header>span[data-utags_flag=tag_page]+.utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: 2px;--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) .box .header>span[data-utags_flag=tag_page]+.utags_ul_1{object-position:200% 50%;position:absolute;top:-9999px}:not(#a):not(#b):not(#c) .xna-entry,:not(#a):not(#b):not(#c) .planet-post{--utags-list-node-display: flex}'
  var v2ex_default2 = (() => {
  ...
  var plus_forums_default_style =
    ":not(#a):not(#b):not(#c) #breadcrumbs .crumbs-item.current>strong{display:flex!important;flex-wrap:wrap!important;align-items:center!important}:not(#a):not(#b):not(#c) #breadcrumbs .crumbs-item.current>strong>.utags_ul{order:-1!important;margin-right:4px!important;--utags-notag-ul-disply:inline;--utags-notag-ul-position:unset}"
  var plus_forums_default = (() => {
    function getCanonicalUrl2(url) {
      try {
        const u = new URL(url, location.href)
        if (!/(?:soul|north|south|white|level|summer|spring|snow|east|blue)-plus\.net$/.test(u.hostname)) {
          return url
        }
        let search = u.search
        if (search.startsWith("?")) {
          const body = search.slice(1).replace(/\.html?$/, "").replace(/[#&].*$/, "")
    ...
    return {
      matches:
        /(?:soul|north|south|white|level|summer|spring|snow|east|blue)-plus\.net$/,
      listNodesSelectors: [
        "li.dcsns-li",
        "tbody tr.tr3",
        ".threadlist li",
      ...
      validate(element, href) {
        if (element.id === "favor") return false
        if (element.hasAttribute("onclick") && !element.getAttribute("href")) return false
        if (element.querySelector("img") && !element.textContent.trim()) return false
        return true
      },
      excludeSelectors: [
        ...default_default2.excludeSelectors,
        "a#favor",
        "a[onclick]:not([href])",
        ".section-text div a:has(> img)",
        ".pagelink a",
        ".pages a",
        'a[href^="javascript:"]',
      ],
      getStyle: () => plus_forums_default_style,
      getCanonicalUrl: getCanonicalUrl2,
    }
  })()
  ...
  var youtube_com_default =
    ':not(#a):not(#b):not(#c) *+.utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) *+.utags_ul_1{object-position:0% 200%}:not(#a):not(#b):not(#c) ytd-rich-item-renderer h3.ytd-rich-grid-media .utags_ul_0{--utags-notag-ul-disply: var(--utags-notag-ul-disply-2);--utags-notag-ul-height: var(--utags-notag-ul-height-2);--utags-notag-ul-position: var(--utags-notag-ul-position-2);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-2);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-2);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) ytd-rich-item-renderer yt-formatted-string[ellipsis-truncate-styling] .utags_ul_0 .utags_captain_tag{left:-20px}:not(#a):not(#b):not(#c) ytd-video-renderer.ytd-item-section-renderer h3 .utags_ul_0,:not(#a):not(#b):not(#c) ytd-video-renderer.ytd-vertical-list-renderer h3 .utags_ul_0{--utags-notag-ul-disply: var(--utags-notag-ul-disply-2);--utags-notag-ul-height: var(--utags-notag-ul-height-2);--utags-notag-ul-position: var(--utags-notag-ul-position-2);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-2);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-2);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) ytd-video-renderer.ytd-item-section-renderer yt-formatted-string.ytd-channel-name .utags_ul_0 .utags_captain_tag,:not(#a):not(#b):not(#c) ytd-video-renderer.ytd-vertical-list-renderer yt-formatted-string.ytd-channel-name .utags_ul_0 .utags_captain_tag{left:-20px}:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn svg{margin:1px;fill:none}:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn svg path{stroke:#000}:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn:hover svg,:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn.starred:hover svg{fill:none}:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn:hover svg path,:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn.starred:hover svg path{stroke:#000}:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn.starred svg{fill:var(--utags-star-tag-color)}:not(#a):not(#b):not(#c) .utags_custom_bookmark_btn.starred svg path{stroke:var(--utags-star-tag-color)}:not(#a):not(#b):not(#c) #title h1.ytd-watch-metadata[data-utags_fit_content="1"]{max-width:fit-content !important}:not(#a):not(#b):not(#c) .watch-active-metadata ytd-channel-name yt-formatted-string.ytd-channel-name{flex-direction:column}:not(#a):not(#b):not(#c) .watch-active-metadata ytd-channel-name yt-formatted-string.ytd-channel-name .utags_ul_1{margin:auto 0 !important}:not(#a):not(#b):not(#c) .watch-active-metadata__ ytd-channel-name yt-formatted-string .utags_ul_0,:not(#a):not(#b):not(#c) ytd-comment-thread-renderer h3.ytd-comment-renderer .utags_ul_0{--utags-notag-ul-disply: var(--utags-notag-ul-disply-2);--utags-notag-ul-height: var(--utags-notag-ul-height-2);--utags-notag-ul-position: var(--utags-notag-ul-position-2);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-2);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-2);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) .ytd-shorts ytd-reel-video-renderer ytd-channel-name yt-formatted-string .utags_ul_0 .utags_captain_tag{left:-24px}:not(#a):not(#b):not(#c) [hidden]+.utags_ul{display:none !important}'
      ...
      if (url.startsWith(prefix2)) {
        ...
        if (exact) {
          if (/^(?:people|org)\/[\w-]+(\?.*)?$/.test(href2)) {
            return prefix2 + href2.replace(/^((?:people|org)\/[\w-]+).*/, "$1")
          }
  ...
  var pixiv_net_default =
    ":not(#a):not(#b):not(#c) *+.utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) *+.utags_ul_1{object-position:0% 200%}:not(#a):not(#b):not(#c) .charcoal-modal-body .overflow-y-auto{position:relative}:not(#a):not(#b):not(#c) [data-utags_list_node][data-pixiv_utils_blocked]{display:var(--utags-list-node-display)}"
  ...
  var nodeseek_com_default =
    ":not(#a):not(#b):not(#c) .utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) .utags_ul_1{object-position:0% 200%}:not(#a):not(#b):not(#c) ul.post-list li.post-list-item{--utags-list-node-display: flex}:not(#a):not(#b):not(#c) ul.post-list li.post-list-item a.post-category+.utags_ul_0{object-position:-100% 50%}:not(#a):not(#b):not(#c) ul.post-list li.post-list-item a.post-category+.utags_ul_1{object-position:-100% 50%;position:absolute;top:-9999px}:not(#a):not(#b):not(#c) .nsk-post-wrapper .author-info ul.utags_ul_1{vertical-align:middle !important}:not(#a):not(#b):not(#c) .nsk-post-wrapper .author-info ul.utags_ul_1 a.utags_text_tag{height:15px !important}:not(#a):not(#b):not(#c) .hover-user-card{z-index:100}"
  ...
  function Discuz(options) {
    const {
      matchesPatternValue,
      normalizeDomainFn,
      validateDefaultReturnValue,
    } = options || {}
    ...
    function getCanonicalUrl2(url, hostname2) {
      ...
      href2 = getPostUrl(prefix2, url)
      if (href2) {
        return href2
      }
      return url
    }
    function getUserProfileUrl(prefix2, url, exact = false) {
      if (url.startsWith(prefix2)) {
    ...
    function getPostUrl(prefix2, url) {
      if (url.startsWith(prefix2)) {
        const href2 = url.slice(prefix2.length).toLowerCase()
    ...
    this.validate = (element, href) => {
      ...
      if (key) {
        ...
        if (
          ...
          title2 === "\u7F6E\u9876" ||
          /^\d+$/.test(title2) ||
          /^\d{4}(?:-\d{1,2}){2} \d{2}:\d{2}(:\d{2})?$/.test(title2)
        ) {
          return false
        }
    ...
    this.getStyle = () => discuz_default
    this.getCanonicalUrl = getCanonicalUrl2
  }
  var discuz = new Discuz()
  var discuz_default2 = discuz
  ...
  var e_hentxx_org_default =
    ':not(#a):not(#b):not(#c) *+.utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) *+.utags_ul_1{object-position:0% 200%}:not(#a):not(#b):not(#c) div.gt a+.utags_ul_0,:not(#a):not(#b):not(#c) div.gtl a+.utags_ul_0,:not(#a):not(#b):not(#c) div.gtw a+.utags_ul_0{--utags-notag-ul-disply: var(--utags-notag-ul-disply-3);--utags-notag-ul-height: var(--utags-notag-ul-height-3);--utags-notag-ul-position: var(--utags-notag-ul-position-3);--utags-notag-ul-top: var(--utags-notag-ul-top-3);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-3);--utags-notag-captain-tag-left: 24px;--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) .gl2e a+.utags_ul_1{object-position:0% 200%;position:absolute;top:-9999px;z-index:100;margin-top:0px !important}:not(#a):not(#b):not(#c) .gl3m.glname a+.utags_ul_0{z-index:100}:not(#a):not(#b):not(#c) .gl3m.glname .glink[data-utags_fit_content="1"],:not(#a):not(#b):not(#c) .gl3c.glname .glink[data-utags_fit_content="1"],:not(#a):not(#b):not(#c) .gl4e.glname .glink[data-utags_fit_content="1"]{max-width:fit-content !important}:not(#a):not(#b):not(#c) .gl4t.glname.glink[data-utags_fit_content="1"],:not(#a):not(#b):not(#c) h1[data-utags_fit_content="1"]{max-width:fit-content !important;margin-left:auto;margin-right:auto}'
  var e_hentxx_org_default2 = (() => {
    const xx = atob("YWk=")
    const prefix2 = "https://e-hent".concat(xx, ".org/")
    const prefix22 = "https://exhent".concat(xx, ".org/")
    function getPostUrl(url) {
      const match = url.match(/(https?:\/\/[^/]+\/g\/\d+\/\w+\/)/i)
      if (match) {
        return match[1]
      }
      if (url.startsWith(prefix2)) {
        ...
        if (/^g\/\d+/.test(href2)) {
          return prefix2 + href2.replace(/^(g\/\d+\/\w+\/).*/, "$1")
        }
      }
      if (url.startsWith(prefix22)) {
        const href2 = url.slice(21)
        if (/^g\/\d+/.test(href2)) {
          return prefix22 + href2.replace(/^(g\/\d+\/\w+\/).*/, "$1")
        }
      }
      return void 0
    }
    ...
    return {
      matches: /(e-hen|exhen)tai\.org|ehentai-toplist-archive\.com|127\.0\.0\.1|localhost/,
      preProcess() {
        const key = getPostUrl(location.href)
        if (key) {
  ...
  var anime_sharing_com_default =
    ":not(#a):not(#b):not(#c) .structItem.structItem--thread{--utags-list-node-display: table}"
  var anime_sharing_com_default2 = (() => {
    const prefix2 = "https://www.anime-sharing.com/"
    function getPostUrl(url, exact = false) {
      if (url.startsWith(prefix2)) {
        const href2 = url.slice(prefix2.length)
        if (exact) {
    ...
    return {
      ...
      getStyle: () => anime_sharing_com_default,
      getCanonicalUrl: getCanonicalUrl2,
    }
  })()
      ...
      if (url.startsWith(prefix2)) {
        ...
        if (exact) {
          if (/^(\w+)\/([^/]+-)?(\d+\.html)$/.test(href2)) {
            return (
              prefix2 + href2.replace(/^(\w+)\/([^/]+-)?(\d+\.html).*/, "$1/$3")
            )
          }
  ...
  var misskon_com_default =
    ":not(#a):not(#b):not(#c) aside .widget-container>.post-thumbnail .utags_ul{display:none !important}:not(#a):not(#b):not(#c) a.yarpp-thumbnail{--utags-list-node-display: inline-block}"
  var misskon_com_default2 = (() => {
    const prefix2 = "https://misskon.com/"
    function getCanonicalUrl2(url) {
      if (url.startsWith(prefix2)) {
    ...
    return {
      ...
      preProcess() {
        ...
        {
          const elements = $$("aside .widget-container > .post-thumbnail a")
          for (const element of elements) {
      ...
      validMediaSelectors: ["aside .widget-container > .post-thumbnail a img"],
      postProcess() {
        const isDarkMode = false
        doc.documentElement.dataset.utags_darkmode = isDarkMode ? "1" : "0"
      },
      getStyle: () => misskon_com_default,
      getCanonicalUrl: getCanonicalUrl2,
    }
  })()
  var nyaa_si_default = ':not(#a):not(#b):not(#c) *+.utags_ul_0{object-position:200% 50%;--utags-notag-ul-disply: var(--utags-notag-ul-disply-5);--utags-notag-ul-height: var(--utags-notag-ul-height-5);--utags-notag-ul-position: var(--utags-notag-ul-position-5);--utags-notag-ul-top: var(--utags-notag-ul-top-5);--utags-notag-captain-tag-top: var(--utags-notag-captain-tag-top-5);--utags-notag-captain-tag-left: var(--utags-notag-captain-tag-left-5);--utags-captain-tag-background-color: var( --utags-captain-tag-background-color-overlap )}:not(#a):not(#b):not(#c) *+.utags_ul_1{object-position:0% 200%}:not(#a):not(#b):not(#c) .table tbody tr td[colspan="2"]{--utags-list-node-display: table-cell}'
  var nyaa_si_default2 = (() => {
    function getCanonicalUrl2(url) {
      if (!/^(sukebei\.)?nyaa\.si$/.test(new URL(url).hostname)) {
        return url
      }
      return url.replace(/[?#].*/, "")
    }
    return {
      matches: /^(sukebei\.)?nyaa\.si$/,
      preProcess() {
        setVisitedAvailable(true)
        if (location.pathname.startsWith("/view/")) {
          const key = location.origin + location.pathname
          const element = $("h3.panel-title")
          if (element) {
            setUtagsAttributes(element, { key, type: "torrent" })
            addVisited(key)
          }
        }
      },
      ...
      conditionNodesSelectors: [
        '.table tbody tr td[colspan="2"] a[href^="/view/"]',
        'table tbody tr td[colspan="2"] a[href^="/view/"]',
      ],
      validate(element, href) {
        const origin = location.origin
        if (href.startsWith(origin + "/view/")) {
          const title = element.getAttribute("title") || element.textContent.trim()
          if (!title) return false
          const key = href.replace(/[?#].*/, "")
          const meta = { type: "torrent", title }
          setUtags(element, key, meta)
          setAttribute(element, "data-utags", element.dataset.utags || "")
          return true
        }
  ...
  var sites = [
    ...
    xsi77jishe_net_default,
    simpxxcity_cr_default2,
    anime_sharing_com_default2,
    hotgixx_asia_default2,
    nhentxx_net_default2,
    hito99mi_la_default2,
    misskon_com_default2,
    nyaa_si_default2,
  ]
  var BASE_EXCLUDE_SELECTOR = "[data-utags_exclude],a a,svg"
    ...
    try {
      ...
      for (const getCanonicalUrlFunc of getCanonicalUrlFunctionList) {
        if (getCanonicalUrlFunc) {
          const newUrl = getCanonicalUrlFunc(url, hostname2)
  ...
  async function registerOrUpdateHideAllTagsMenu() {
    const title = "\u{1F648} ".concat(
      isAllTagsHidden() ? i2("menu.unhideAllTags") : i2("menu.hideAllTags")
    )
    const options = {}
    if (hideAllTagsMenuId === void 0) {
  ...
  function updateDocumentElementAttributes() {
    ...
    {
      const newValue = getSettingsValue("enableCurrentSite_".concat(host2))
        ? host2
        : "off"
  ...
  function getUtagsTargetElementByElement(element) {
  ...
  function appendUtagsToElement(element, utagsUl) {
    if (!utagsUl) {
      return
    }
  ...
  async function displayTags() {
    ...
    for (const node of listNodes) {
      if (node.dataset.utags_list_node === void 0) {
  ...
  var tagPositionUpdateQueue = []
  var tagPositionUpdateSet = /* @__PURE__ */ new Set()
  var isProcessingTagPositionQueue = false
  ...
  function processTagPositionUpdatesIdle(deadline) {
    while (
  ...
  function enqueueTagPositionUpdate(target) {
